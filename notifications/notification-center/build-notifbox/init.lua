...
local empty_notifbox = require("notifications.notification-center.build-notifbox.empty-notifbox")
...
local remove_notifbox = function(box)
...
naughty.connect_signal("added", function(n)
	...
	local box = require("notifications.notification-center.build-notifbox.notifbox")
