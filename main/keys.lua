...
-- ColorPicker
-- Set Layout
globalkeys = gears.table.join(awful.key({"Mod1"}, "a", function()
...
awful.key({modkey}, "Tab", function() end),
    -- ===================================================================

 awful.key({modkey, "Shift"}, "Tab", function() end),
    -- ===================================================================
...
-- ===================================================================
    ...
    awful.spawn.easy_async_with_shell("slop -b 2 -c '0.61,0.9,0.75,1' -p -2",
                                      function(out)
        local mywidth, myheight, myx, myy =
            string.match(out, "(.*)x(.*)+(.*)+(.*)")
        awful.spawn(terminal, {
            geometry = {x = myx, y = myy, height = myheight, width = mywidth},
            floating = true
        })
    end)
...
awful.key({modkey}, "F4", function()
    ...
    -- ===================================================================
awful.key({modkey}, "F2", function() awful.spawn.with_shell("firefox") end,
