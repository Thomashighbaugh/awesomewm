...
function helpers.move_to_edge(c, direction)
	...
	elseif direction == "down" then
		...
		c:geometry({
			nil,
			y = workarea.height + workarea.y - client_geometry.height - beautiful.screen_margin * 2 - beautiful.border_width * 2,
			nil,
			nil,
		})
	...
	elseif direction == "right" then
		...
		c.y = old_y
		c:geometry({
			x = workarea.width + workarea.x - client_geometry.width - beautiful.screen_margin * 2 - beautiful.border_width * 2,
			nil,
			nil,
			nil,
		})
