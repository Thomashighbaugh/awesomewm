...
-- Font
theme.font = "SF Intermosaic B Bold"
theme.font_bold = theme.font
theme.font_heavy = theme.font .. " 8"
...
theme.tasklist_font = theme.font .. " 8"
...
theme.tabbar_font = theme.font .. " 8" -- font of the tabbar
