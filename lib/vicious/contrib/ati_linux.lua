...
local string = {sub = string.sub, match = string.match, gmatch = string.gmatch}
-- }}}
...
local function worker(format, warg)
    ...
    _data["{dpm_state}"] = pm.power_dpm_state and
                               string.sub(pm.power_dpm_state, 1, -2) or "N/A"
    _data["{dpm_perf_level}"] = pm.power_dpm_force_performance_level and
                                    string.sub(
                                        pm.power_dpm_force_performance_level, 1,
                                        -2) or "N/A"
    _data["{profile}"] = pm.power_profile and
                             string.sub(pm.power_profile, 1, -2) or "N/A"
