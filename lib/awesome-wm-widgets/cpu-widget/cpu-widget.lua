...
local WIDGET_DIR = HOME_DIR ..
                       '/.config/awesome/lib/awesome-wm-widgets/cpu-widget'
...
local function create_process_header(params)
    local res = wibox.widget {
        ...
        create_textbox {markup = '<b>Name</b>'},
        {
            ...
            params.with_action_column and create_textbox {forced_width = 50} or
                nil,
...
local function worker(args)
    ...
    local cpu_widget = wibox.container.margin(
                           wibox.container.mirror(cpugraph_widget,
                                                  {horizontal = true}), 0, 0, 0,
                           2)
                ...
                if starts_with(line, 'cpu') then
                    ...
                    local row = wibox.widget {
                        ...
                        create_textbox {text = math.floor(diff_usage) .. '%'},
                        {
                            ...
                            color = "linear:150,0:0,0:0," .. beautiful.xcolor1 ..
                                ",#BF616A:0.6," .. beautiful.xcolor2,
                    ...
                    if is_update == true then
                        ...
                        pid_name_rest:ajust_ratio(2, 2, 4, 3)
                        ...
                        awful.tooltip {
                            ...
                            timer_function = function()
                                ...
                                if process_info_max_length > 0 and text:len() >
                                    ...
                                    text =
                                        text:sub(0, process_info_max_length - 3) ..
                                            '...'
                                end
