...
local function worker(args)
    ...
    storage_bar_widget = wibox.widget {
        ...
        color = "linear:150,0:0,0:0," .. beautiful.fg_normal .. ":0.3," ..
    ...
    local disks = {}
    watch([[bash -c "df | tail -n +2"]], 60, function(widget, stdout)
        ...
        for k, v in ipairs(mounts) do
            ...
            local row = wibox.widget {
                ...
                },
                {
                    ...
                    bar_border_width = 1,
                    bar_border_color = beautiful.bg_focus,
                    color = "linear:150,0:0,0:0," .. beautiful.fg_normal ..
        ...
        popup:setup{
            {disk_header, disk_rows, layout = wibox.layout.fixed.vertical},
            margins = 8,
