    ...
    awful.prompt.run {
        ...
        exe_callback = function(input_text)
            ...
            spawn.easy_async(GET_TODO_ITEMS, function(stdout)
                ...
                table.insert(res.todo_items,
                             {todo_item = input_text, status = false})
                spawn.easy_async_with_shell(
                    "echo '" .. json.encode(res) .. "' > " .. STORAGE,
                    function()
                        spawn.easy_async(GET_TODO_ITEMS, function(stdout)
    ...
    function update_widget(stdout)
        ...
        for i, todo_item in ipairs(result.todo_items) do
            ...
            trash_button:connect_signal("button::press", function(c)
                ...
                spawn.easy_async_with_shell(
                    "printf '" .. json.encode(result) .. "' > " .. STORAGE,
                    function()
                        spawn.easy_async(GET_TODO_ITEMS, function(stdout)
                            update_widget(stdout)
                        end)
            ...
            local move_buttons = {layout = wibox.layout.fixed.vertical}
