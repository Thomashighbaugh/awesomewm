...
local function factory(args)
    ...
    function weather.show(seconds)
        ...
        if followtag then notification_preset.screen = focused() end
    ...
    function weather.forecast_update()
        ...
        helpers.async(cmd, function(f)
            ...
            if not err and type(weather_now) == "table" and
                tonumber(weather_now["cod"]) == 200 then
    ...
    weather.timer = helpers.newtimer("weather-" .. city_id, timeout,
                                     weather.update, false, true)
    weather.timer_forecast = helpers.newtimer("weather_forecast-" .. city_id,
                                              timeout, weather.forecast_update,
                                              false, true)
