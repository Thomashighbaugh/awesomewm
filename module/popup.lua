--[[  ___
___ _______ ______ _______ ______   __              
|   __ \       |   __ \   |   |   __ \ |  |.--.--.---.-.
|    __/   -   |    __/   |   |    __/_|  ||  |  |  _  |
|___|  |_______|___|  |_______|___| |__|__||_____|___._|
...
local function build_popup(args)
    ...
    local other_margin = 0.5 * (awful.screen.focused().geometry.width - popup_box_width)
    ...
    awesome.connect_signal(
        ...
        function(bool)
            if not popup_box.visible and bool then
                ...
                other_margin = 0.5 * (awful.screen.focused().geometry.width - popup_box_width)
                placement_osd()
            end
