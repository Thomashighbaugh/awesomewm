...
local clickable_container = require( "layout.clickable-container" )

local dpi = beautiful.xresources.apply_dpi
local ICON_DIR = gears.filesystem.get_configuration_dir( ) .. "/themes/clone/"
...
local function lock_command( )
    exit_screen.hide( )
    awful.spawn.with_shell( "sleep 1 && " )
end
