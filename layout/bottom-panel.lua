...
local bottom_panel = function(s)
	...
	s.tray_toggler  = build_widget(require('widgets.tray-toggler'))
	s.bluetooth   	= build_widget(require('widgets.bluetooth')())
	s.network        	= build_widget(require('widgets.network')())
	s.search      	= require('widgets.search-apps')()
