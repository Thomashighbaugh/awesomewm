...
local poppin = require("external.lib.poppin")
...
function _M.get()
    local globalkeys =
        ...
        awful.key({modkey}, "Insert", hotkeys_popup.show_help, {description = "show help", group = "awesome"}),
        -- ===================================================================
        ...
        awful.key(
            ...
            "`",
            function()
                quakeconsole[s]:toggle()
            end,
            {description = "Quake Terminal"}
        ),
        -- ===================================================================
        -- Revelation
        awful.key({modkey}, "e", revelation, {description = "show all windows", group = "awesome"}),
        -- ===================================================================
