--[[ TASKLIST.lua
     ...
     Description:
    This critical piece of the modern OS too often excluded even by big DEs, like gnome, is critical to my workflow. 
	Not as icons alone, I need some context about the content to be most effective even if I alt tab through most things anyway, 
	I have opted for leaving myself a wide swath of means and methodology to interact with my windows absent in other tiling window
	 managers as it strealines their use in moments of frantic importance and prevents the temptation of returning to some awful DE --]]
