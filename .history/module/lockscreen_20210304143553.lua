--[[ 
	 _____   _______ ______ __  __ _______ ______ ______ _______ _______ _______    __              
|     |_|       |      |  |/  |     __|      |   __ \    ___|    ___|    |  |  |  |.--.--.---.-.
|       |   -   |   ---|     <|__     |   ---|      <    ___|    ___|       |__|  ||  |  |  _  |
|_______|_______|______|__|\__|_______|______|___|__|_______|_______|__|____|__|__||_____|___._|
by Thomas Leon Highbaugh
     ...
     Description:
       the lockscreen implementation within lua, a little fickle but
       works well enough
--]]
...
lock_widget.build_animation_arc = function(icon)
	...
	awesome.connect_signal(
		'module::lock_screen:key_animation',
		function(char_inserted)
			local color
...
lock_widget.build_button = function(args, icon, function_table, name)
	local clickable_icon,
		image_to_change = clickable_image(args, icon, function_table)
	local button_text =
		wibox.widget {
		text = name,
...
lock_widget.poweroff_command = function()
...
lock_widget.build_leave_widget = function()
	...
	local poweroff_button =
		lock_widget.build_button(
		button_args,
		icons.power,
		function()
			lock_widget.poweroff_command()
		end,
		'Shutdown'
	)
...
awesome.connect_signal(
	'module::lock_screen:hide',
	function()
		lock_widget.locked = true
	end
)
