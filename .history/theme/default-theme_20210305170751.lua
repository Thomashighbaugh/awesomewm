...
theme.groups_title_bg = theme.xbackground .. '66'
theme.groups_bg = theme.xbackground .. '66'
...
theme.menu_bg_normal = theme.xbackground .. '66'
...
theme.tasklist_font = 'SF Mono Heavy 16'
...
-- Popup
theme.popup_bg = theme.xbackground .. 'aa'

-- Notification

theme.notification_bg1 = theme.xbackground .. '40'
theme.notification_bg2 = theme.xbackground .. '40'
...
theme.panel_bg = theme.xbackground .. '66'
theme.panel_radius = dpi(12)
theme.panel_widget_border_width = dpi(0)
theme.panel_widget_border_color = theme.xbackground .. '00'
...
theme.small_panel_bg = theme.xbackground .. '66'
