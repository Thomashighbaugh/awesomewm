...
-- ===================================================================
 awful.key({modkey}, "F2",
    function() awful.spawn("firefox-nightly") end, 
        { description = "Open Firefox Nightly",     group = "launcher"}), 
 -- ===================================================================
 ...
 -- ===================================================================
                 awful.key({modkey, "Control"}, "F2",
                           function() awful.spawn("epiphany") end, {
        description = "Open Epiphany Browser",
        group = "launcher"
    }), -- ===================================================================
    ...
    -- ===================================================================
        ...
        description = "Open File Manager as Root",
        group = "launcher"
    }), -- ===================================================================
    awful.key({modkey, "Shift"}, "F3", function() awful.spawn("thunar") end,
    ...
    awful.key({modkey}, "F4", function() awful.spawn.with_shell("code") end,
              {description = "open Code OSS", group = "launcher"}),
    -- ===================================================================
    ...
    awful.key({modkey, "Shift"}, "Return",
              function() awful.spawn("sudo kitty -e") end,
