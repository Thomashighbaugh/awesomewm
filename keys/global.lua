...
local globalKeys = awful.util.table.join(
    ...
    awful.key(
        { modkey,           },
        "F3",
        function () awful.spawn(file_manager)
        end,
    ...
    awful.key(
        { modkey,           },
        "F4",
        function()    awful.spawn.with_shell("fa-rofi")
        end,
    ...
    awful.key(
        { modkey,"Control"           },
        "F4",
        function()    awful.spawn.with_shell("emojipick")
        end,
        {description = "Copy Emojis to Clipboard", group = 'Launcher'}),


    awful.key({ modkey,           }, "F5", function()    awful.spawn.with_shell("sudo picom -b && notify-send 'Picom Activated'") end,
    ...
    awful.key(
        { modkey, "Control"           },
        "F5",
        function()    awful.spawn.with_shell("sudo pkill picom  && notify-send 'Picom Deactivated'")
        end,
