...
local take_screen_shot = function()
	...
	local command = "/home/tlh/.config/awesome/external/bin/screenshots full"
	...
	open_file:connect_signal(
		"invoked",
		function()
			awful.spawn.with_shell("nemo " .. screen_shot_dir .. file_name, false)
		end
	)
	...
	open_dir:connect_signal(
		"invoked",
		function()
			awful.spawn.with_shell("nemo " .. screen_shot_dir, false)
		end
	)
